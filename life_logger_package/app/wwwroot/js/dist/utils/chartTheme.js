...
export function createTerminalChartOptions(title) {
    return {
        responsive: true,
...
export function createTimeSeriesOptions(title) {
    return {
        responsive: true,
        maintainAspectRatio: false,
        plugins: {
...
export function createBarChartOptions(title) {
    return {
        responsive: true,
        maintainAspectRatio: false,
        plugins: {
...
export function getDatasetColors(dataCount) {
