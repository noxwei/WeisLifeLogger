...
import { createTimeSeriesOptions, createBarChartOptions, createDoughnutOptions, terminalColors, getDatasetColors } from '../utils/chartTheme.js';
...
export class TerminalCharts {
    ...
    static createTimeSeriesChart(canvasId, entries, metric) {
    ...
    static createHourlyActivityChart(canvasId, entries) {
        const canvas = document.getElementById(canvasId);
        if (!canvas)
            return null;
        this.destroyChart(canvasId);
    ...
    static createLocationFrequencyChart(canvasId, entries) {
        const canvas = document.getElementById(canvasId);
        if (!canvas)
            return null;
        this.destroyChart(canvasId);
    ...
    static createWeeklyPatternChart(canvasId, entries) {
        const canvas = document.getElementById(canvasId);
        if (!canvas)
            return null;
        this.destroyChart(canvasId);
    ...
    static createStepsProgressChart(canvasId, entries) {
        const canvas = document.getElementById(canvasId);
        if (!canvas)
            return null;
        this.destroyChart(canvasId);
    ...
    static createDeviceBatteryChart(canvasId, entries) {
        const canvas = document.getElementById(canvasId);
        if (!canvas)
            return null;
        this.destroyChart(canvasId);
